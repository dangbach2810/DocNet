      ...
      private void btnInsert_Click(object sender, EventArgs e)
         {
             ...
             else
             {
                 ...
                 product.ImportUnitPrice = int.Parse(txtImportUnitPrice.Text);
                 product.UnitPrice = int.Parse(txtUnitPrice.Text);
                 product.Note = txtNote.Text;
                 var check = busProduct.InsertProduct(product);
                 if (check)
                 {
                     gvProduct.DataSource = busProduct.ListOfProducts();
                     LoadGridView();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
         {
            if (MessageBox.Show("Bạn có chắc muốn sửa?", "Xác nhận", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                else
                {
                    ...
                    product.UnitPrice = int.Parse(txtUnitPrice.Text);
                    product.Note = txtNote.Text;
                    var check = busProduct.UpdateProduct(product);
                    if (check)
                    {
                        gvProduct.DataSource = busProduct.ListOfProducts();
                        LoadGridView();
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                gvProduct.DataSource = busProduct.SearchProduct(txtSearch.Text);
